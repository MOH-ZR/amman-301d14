...
function displayPics() {
    ...
    /* because let is blocked scope. In other words, with let, 
       the 'rando' variable cann't be seen outside its block 
       which is the outer 'while' loop block. however, using var 
       it can be accessed out of while loop block and inside the same function block;
    */
    console.log(viewed);
